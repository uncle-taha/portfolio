...
const allComponents = [<Cart />, <ProductsPage /> /* ... */];
...
function BlogPage() {
  ...
  return (
    <div className="container mx-auto py-4 max-w-6xl bg-white rounded-2xl mt-25 mb-15  dark:bg-gray-900 border-white/80 dark:shadow-lg shadow-black/4 backdrop-blur-[5.2px] border">
